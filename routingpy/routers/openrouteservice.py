                ...
                for route in response["features"]:
                    routes.append(
                        Direction(
                            ...
                            distance=int(route["properties"]["summary"]["distance"]) if route["properties"]["summary"] else 0,
                            duration=int(route["properties"]["summary"]["duration"]) if route["properties"]["summary"] else 0,
                            raw=route,
                        )
                    )
